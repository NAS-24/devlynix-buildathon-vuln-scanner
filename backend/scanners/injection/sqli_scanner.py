...
class SQLiScanner(BaseScanner):
    ...
    async def _test_url_params(self, client: httpx.AsyncClient, url: str) -> dict | None:
        parsed = urlparse(url)
        ...
        for param_name in params:
            for payload in SQLI_PAYLOADS:
                ...
                try:
                    ...
                    db_match = self._check_response(resp.text)
                    if db_match:
                        return {
                            "payload": payload,
                            "param":   param_name,
